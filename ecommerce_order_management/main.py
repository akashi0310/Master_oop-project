...
if order1:
    print(f"[OK] Order {order1.order_id} created successfully!")
...
if order2:
    print(f"[OK] Order {order2.order_id} created successfully!")
...
if order3:
    print(f"[OK] Order {order3.order_id} created successfully!")

# Update order status
print("\n8. Shipping an order...")
updated = update_order_status(order1.order_id, 'shipped')
if updated:
    print(f"[OK] Order {order1.order_id} marked as shipped")
